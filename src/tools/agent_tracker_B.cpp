...
int main(int argc, char **argv){
    ...
    Cv_server cv_server(camera_configuration, cam_file, bg_path, config.videos_folder, tracking_server, experiment_client, sync_led_locations, p.contains(params_cpp::Key("-u")));
